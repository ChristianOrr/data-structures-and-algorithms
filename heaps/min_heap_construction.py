...
MinHeap(array): - // instantiate a MinHeap (calls the build_heap method and populates the heap)
build_heap(array): - [-5, 2, 6, 7, 8, 8, 24, 391, 24, 56, 12, 24, 48, 41]
insert(76): - [-5, 2, 6, 7, 8, 8, 24, 391, 24, 56, 12, 24, 48, 41, 76]
peek(): -5
remove(): -5 [2, 7, 6, 24, 8, 8, 24, 391, 24, 56, 12, 24, 48, 41]
peek(): 2
...
class MinHeap:
    ...
    def build_heap(self, array):
        ...
        for index in reversed(range(first_parent + 1)):
            self.sift_down(index, len(array) - 1, array)
        return array
    ...
    def insert(self, value):
        ...
        self.sift_up(index, self.heap)



def is_min_heap_property_satisfied(array):
